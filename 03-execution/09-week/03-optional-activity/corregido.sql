...
CREATE TABLE country (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    continent_id uuid NOT NULL REFERENCES continent(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE state_province (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    country_id uuid NOT NULL REFERENCES country(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE city (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    state_province_id uuid NOT NULL REFERENCES state_province(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    time_zone_id uuid NOT NULL REFERENCES time_zone(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE district (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    city_id uuid NOT NULL REFERENCES city(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE address (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    district_id uuid NOT NULL REFERENCES district(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE airline (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    home_country_id uuid NOT NULL REFERENCES country(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE person (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    person_type_id uuid NOT NULL REFERENCES person_type(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    nationality_country_id uuid REFERENCES country(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE person_document (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    person_id uuid NOT NULL REFERENCES person(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    document_type_id uuid NOT NULL REFERENCES document_type(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    issuing_country_id uuid REFERENCES country(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE person_contact (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    person_id uuid NOT NULL REFERENCES person(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    contact_type_id uuid NOT NULL REFERENCES contact_type(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE user_account (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    person_id uuid NOT NULL REFERENCES person(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    user_status_id uuid NOT NULL REFERENCES user_status(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE user_role (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    user_account_id uuid NOT NULL REFERENCES user_account(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    security_role_id uuid NOT NULL REFERENCES security_role(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE role_permission (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    security_role_id uuid NOT NULL REFERENCES security_role(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    security_permission_id uuid NOT NULL REFERENCES security_permission(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE loyalty_program (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    airline_id uuid NOT NULL REFERENCES airline(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    default_currency_id uuid NOT NULL REFERENCES currency(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE loyalty_tier (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    loyalty_program_id uuid NOT NULL REFERENCES loyalty_program(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE customer (
    ...
    airline_id uuid NOT NULL REFERENCES airline(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    person_id uuid NOT NULL REFERENCES person(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    customer_category_id uuid REFERENCES customer_category(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE loyalty_account (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    customer_id uuid NOT NULL REFERENCES customer(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    loyalty_program_id uuid NOT NULL REFERENCES loyalty_program(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE loyalty_account_tier (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    loyalty_account_id uuid NOT NULL REFERENCES loyalty_account(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    loyalty_tier_id uuid NOT NULL REFERENCES loyalty_tier(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE customer_benefit (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    customer_id uuid NOT NULL REFERENCES customer(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    benefit_type_id uuid NOT NULL REFERENCES benefit_type(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE airport (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    address_id uuid NOT NULL REFERENCES address(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE terminal (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    airport_id uuid NOT NULL REFERENCES airport(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE boarding_gate (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    terminal_id uuid NOT NULL REFERENCES terminal(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE aircraft_model (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    aircraft_manufacturer_id uuid NOT NULL REFERENCES aircraft_manufacturer(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE aircraft (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    airline_id uuid NOT NULL REFERENCES airline(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    aircraft_model_id uuid NOT NULL REFERENCES aircraft_model(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE aircraft_cabin (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    aircraft_id uuid NOT NULL REFERENCES aircraft(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    cabin_class_id uuid NOT NULL REFERENCES cabin_class(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE aircraft_seat (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    aircraft_cabin_id uuid NOT NULL REFERENCES aircraft_cabin(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE maintenance_provider (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    address_id uuid REFERENCES address(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE maintenance_event (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    aircraft_id uuid NOT NULL REFERENCES aircraft(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    maintenance_type_id uuid NOT NULL REFERENCES maintenance_type(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    maintenance_provider_id uuid REFERENCES maintenance_provider(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    status_code varchar(20) NOT NULL,
...
CREATE TABLE flight (
    ...
    airline_id uuid NOT NULL REFERENCES airline(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    aircraft_id uuid NOT NULL REFERENCES aircraft(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    flight_status_id uuid NOT NULL REFERENCES flight_status(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE flight_segment (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    flight_id uuid NOT NULL REFERENCES flight(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    origin_airport_id uuid NOT NULL REFERENCES airport(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    destination_airport_id uuid NOT NULL REFERENCES airport(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE flight_delay (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    flight_segment_id uuid NOT NULL REFERENCES flight_segment(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    delay_reason_type_id uuid NOT NULL REFERENCES delay_reason_type(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE fare (
    ...
    origin_airport_id uuid NOT NULL REFERENCES airport(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    destination_airport_id uuid NOT NULL REFERENCES airport(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    fare_class_id uuid NOT NULL REFERENCES fare_class(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    currency_id uuid NOT NULL REFERENCES currency(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE reservation (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    booked_by_customer_id uuid REFERENCES customer(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    reservation_status_id uuid NOT NULL REFERENCES reservation_status(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    sale_channel_id uuid NOT NULL REFERENCES sale_channel(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE reservation_passenger (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    reservation_id uuid NOT NULL REFERENCES reservation(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    person_id uuid NOT NULL REFERENCES person(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE ticket (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    sale_id uuid NOT NULL REFERENCES sale(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    reservation_passenger_id uuid NOT NULL REFERENCES reservation_passenger(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    fare_id uuid NOT NULL REFERENCES fare(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    ticket_status_id uuid NOT NULL REFERENCES ticket_status(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE ticket_segment (
    ...
    CONSTRAINT uq_ticket_segment_flight UNIQUE (id, flight_segment_id),
...
CREATE TABLE seat_assignment (
    ...
    aircraft_seat_id uuid NOT NULL REFERENCES aircraft_seat(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    assigned_at timestamptz NOT NULL,
    ...
    CONSTRAINT fk_seat_assignment_ticket_segment FOREIGN KEY (ticket_segment_id, flight_segment_id)
        REFERENCES ticket_segment(id, flight_segment_id)
);

CREATE TABLE baggage (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    ticket_segment_id uuid NOT NULL REFERENCES ticket_segment(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE check_in (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    ticket_segment_id uuid NOT NULL REFERENCES ticket_segment(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    check_in_status_id uuid NOT NULL REFERENCES check_in_status(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    boarding_group_id uuid REFERENCES boarding_group(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    checked_in_by_user_id uuid REFERENCES user_account(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE boarding_pass (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    check_in_id uuid NOT NULL REFERENCES check_in(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE boarding_validation (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    boarding_pass_id uuid NOT NULL REFERENCES boarding_pass(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    boarding_gate_id uuid REFERENCES boarding_gate(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    validated_by_user_id uuid REFERENCES user_account(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE payment (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    sale_id uuid NOT NULL REFERENCES sale(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    payment_status_id uuid NOT NULL REFERENCES payment_status(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    payment_method_id uuid NOT NULL REFERENCES payment_method(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    currency_id uuid NOT NULL REFERENCES currency(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE payment_transaction (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    payment_id uuid NOT NULL REFERENCES payment(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE exchange_rate (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    from_currency_id uuid NOT NULL REFERENCES currency(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    to_currency_id uuid NOT NULL REFERENCES currency(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE invoice (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    sale_id uuid NOT NULL REFERENCES sale(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    invoice_status_id uuid NOT NULL REFERENCES invoice_status(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    currency_id uuid NOT NULL REFERENCES currency(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE invoice_line (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    invoice_id uuid NOT NULL REFERENCES invoice(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    tax_id uuid REFERENCES tax(id) ON DELETE RESTRICT ON UPDATE CASCADE,
